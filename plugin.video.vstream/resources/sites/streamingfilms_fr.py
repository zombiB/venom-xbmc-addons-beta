...
URL_SEARCH1 = ('http://streamingfilms.fr/?s=', 'showMovies')
URL_SEARCH2 = ('http://streaming-series.org/?s=', 'showMovies')
...
def load():
    ...
    oOutputParameterHandler.addParameter('siteUrl', URL_SEARCH1[0])
    oGui.addDir(SITE_IDENTIFIER, 'showMoviesSearch', 'Recherche Films', 'search.png', oOutputParameterHandler)
    
    oOutputParameterHandler = cOutputParameterHandler()
    oOutputParameterHandler.addParameter('siteUrl', URL_SEARCH2[0])
    oGui.addDir(SITE_IDENTIFIER, 'showSerieSearch', 'Recherche Series', 'search.png', oOutputParameterHandler)
    ...
    oGui.addDir(SITE_IDENTIFIER, 'showMovies', 'Films Les plus Comment̩s', 'films.png', oOutputParameterHandler)
    
    oOutputParameterHandler = cOutputParameterHandler()
    oOutputParameterHandler.addParameter('siteUrl', MOVIE_NOTES[0])
    oGui.addDir(SITE_IDENTIFIER, 'showMovies', 'Films Les mieux Not̩s', 'films.png', oOutputParameterHandler)
    ...
    oGui.addDir(SITE_IDENTIFIER, 'showMovies', 'Series Nouveaut̩s', 'series.png', oOutputParameterHandler)
    
    oOutputParameterHandler = cOutputParameterHandler()
    oOutputParameterHandler.addParameter('siteUrl', SERIE_VIEWS[0])
    oGui.addDir(SITE_IDENTIFIER, 'showMovies', 'Series Les plus Vues', 'films.png', oOutputParameterHandler)
    
    oOutputParameterHandler = cOutputParameterHandler()
    oOutputParameterHandler.addParameter('siteUrl', SERIE_COMMENTS[0])
    oGui.addDir(SITE_IDENTIFIER, 'showMovies', 'Series Les plus Comment̩s', 'films.png', oOutputParameterHandler)
    
    oOutputParameterHandler = cOutputParameterHandler()
    oOutputParameterHandler.addParameter('siteUrl', SERIE_NOTES[0])
    oGui.addDir(SITE_IDENTIFIER, 'showMovies', 'Series Les mieux Not̩s', 'films.png', oOutputParameterHandler)
